...
<ol type="a">
	<li>Permission is granted to temporarily download one copy of the
		materials (information or software) on Acme, Inc's web site for
		...
		<ol type="i">
			...
			<li>attempt to decompile or reverse engineer any software
				contained on Acme, Inc's web site;</li>
	...
	<li>This license shall automatically terminate if you violate any
		of these restrictions and may be terminated by Acme, Inc at any time.
...
<ol type="a">
	<li>The materials on Acme, Inc's web site are provided "as is".
		Acme, Inc makes no warranties, expressed or implied, and hereby
		disclaims and negates all other warranties, including without
		limitation, implied warranties or conditions of merchantability,
		fitness for a particular purpose, or non-infringement of intellectual
		property or other violation of rights. Further, Acme, Inc does not
...
<p>In no event shall Acme, Inc or its suppliers be liable for any
	damages (including, without limitation, damages for loss of data or
	profit, or due to business interruption,) arising out of the use or
	inability to use the materials on Acme, Inc's Internet site, even if
	Acme, Inc or a Acme, Inc authorized representative has been notified
...
<p>The materials appearing on Acme, Inc's web site could include
	technical, typographical, or photographic errors. Acme, Inc does not
	warrant that any of the materials on its web site are accurate,
	complete, or current. Acme, Inc may make changes to the materials
	contained on its web site at any time without notice. Acme, Inc does
	not, however, make any commitment to update the materials.</p>

<h3>6. Links</h3>

<p>Acme, Inc has not reviewed all of the sites linked to its
	...
	Acme, Inc of the site. Use of any such linked web site is at the user's
	own risk.</p>

<h3>7. Site Terms of Use Modifications</h3>

<p>Acme, Inc may revise these terms of use for its web site at any
...
<p>Any claim relating to Acme, Inc's web site shall be governed by
	the laws of the State of Spain without regard to its conflict of law
	provisions.</p>
...
<ul>
	<li>Before or at the time of collecting personal information, we
		will identify the purposes for which information is being collected.</li>
	<li>We will collect and use of personal information solely with
		...
		individual concerned or as required by law.</li>
	...
	<li>Personal data should be relevant to the purposes for which it
...
<p>We are committed to conducting our business in accordance with
